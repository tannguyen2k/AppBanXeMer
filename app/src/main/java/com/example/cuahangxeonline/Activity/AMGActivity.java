...
import com.example.cuahangxeonline.Adapter.AMGAdapter;
...
public class AMGActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView listView;
    AMGAdapter amgadapter;
    ArrayList<XeMoi> xeAMGArrayList;
    String idloaixe;
    int page = 1;
    View footer;
    mHanler mHanler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_m_g);
                ...
                if (response != null && response.length()!=2)
                {
                    ...
                    try {
                        ...
                        { JSONObject jsonObject = jsonArray.getJSONObject(i);
                            ...
                            amgadapter.notifyDataSetChanged();
                        }
                    }
    ...
    private void LoadThemXe() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongtinxe",xeAMGArrayList.get(position));
                startActivity(intent);
            }
        });
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.tbamg);
        listView = findViewById(R.id.listviewamg);
        xeAMGArrayList = new ArrayList<>();
        amgadapter = new AMGAdapter(getApplicationContext(), xeAMGArrayList );
        listView.setAdapter(amgadapter);

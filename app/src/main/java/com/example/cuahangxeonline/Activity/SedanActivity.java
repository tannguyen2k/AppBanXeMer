...
public class SedanActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView listView;
    SedanAdapter sedanAdapter;
    ArrayList<XeMoi> xeSedanArrayList;
    String idloaixe;
    int page = 1;
    View footer;
    mHanler mHanler;
    ...
    private void LoadThemXe() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongtinxe",xeSedanArrayList.get(position));
                startActivity(intent);
            }
        });
                ...
                if (response != null && response.length()!=2)
                {
                    ...
                    try {
                        ...
                        { JSONObject jsonObject = jsonArray.getJSONObject(i);
                            xeSedanArrayList.add(new XeMoi(
                            ...
                            sedanAdapter.notifyDataSetChanged();
                        }
                    }
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.tbsedan);
        listView = findViewById(R.id.listviewsedan);
        xeSedanArrayList = new ArrayList<>();
        sedanAdapter = new SedanAdapter(getApplicationContext(), xeSedanArrayList);
        listView.setAdapter(sedanAdapter);
